    ...
    'cassandra': {
         ...
         'OPTIONS': {
             'replication': {
                 ...
                 'replication_factor': env('DJANGO_EXPORT_DB_REPLICATION_FACTOR'),
             },
            'connection': {
                'retry_connect': env('DJANGO_EXPORT_DB_CONNECTION_RETRY_CONNECT'),
                # + All connection options for cassandra.cluster.Cluster()
            },
            'session': {
                'default_timeout': env('DJANGO_EXPORT_DB_SESSION_DEFAULT_TIMEOUT'),
                'default_fetch_size': env('DJANGO_EXPORT_DB_SESSION_DEFAULT_FETCH_SIZE'),
